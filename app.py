...
def webhook():
    try:
        ...
        stop_loss  = data.get('sl', data.get('stop_loss', data.get('plot_0', 'غير محدد')))
        target_1   = data.get('tp1', data.get('target_1', data.get('plot_1', 'غير محدد')))
        target_2   = data.get('tp2', data.get('target_2', data.get('plot_2', 'غير محدد')))
        target_3   = data.get('tp3', data.get('target_3', data.get('plot_3', 'غير محدد')))
